...
@class _UIStatusBarStringView; @class SBIconBadgeView; @class SBIconBetaLabelAccessoryView; @class SBDockView; @class NCNotificationListView; @class NCNotificationListSectionRevealHintView; @class SBIconLegibilityLabelView; @class SBIconRecentlyUpdatedLabelAccessoryView; @class PSCapacityBarCell; @class _UIStatusBar; @class SBIconListPageControl; @class SBIconImageView; 
