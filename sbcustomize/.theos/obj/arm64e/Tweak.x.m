...
static void _logos_method$_ungrouped$AZPlaceModuleView$layoutSubviews(_LOGOS_SELF_TYPE_NORMAL AZPlaceModuleView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    NSDictionary *bundleDefaults = [[NSUserDefaults standardUserDefaults]persistentDomainForName:@"com.sangster.sbcustomizepreferences"];
