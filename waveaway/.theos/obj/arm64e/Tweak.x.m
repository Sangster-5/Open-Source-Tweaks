...
@class SBIconBadgeView; @class SBIconListPageControl; @class SBDockView; @class _UIStatusBar; @class SBIconBetaLabelAccessoryView; @class _UIStatusBarStringView; @class PSCapacityBarCell; @class SBIconLegibilityLabelView; @class NCNotificationListView; @class NCNotificationListSectionRevealHintView; @class SBIconRecentlyUpdatedLabelAccessoryView; @class SBIconImageView; @class SBIconCloudLabelAccessoryView; @class BSUICAPackageView; @class SBFolderTitleTextField; 
