...
static void _logos_method$WaveAway$SBFolderTitleTextField$layoutSubviews(_LOGOS_SELF_TYPE_NORMAL SBFolderTitleTextField* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    if(hideFolderText) {
        [self setHidden:YES];
    }
    
    return _logos_orig$WaveAway$SBFolderTitleTextField$layoutSubviews(self, _cmd);
}
...
static void _logos_method$WaveAway$SBFolderBackgroundView$layoutSubviews(_LOGOS_SELF_TYPE_NORMAL SBFolderBackgroundView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    ...
    return _logos_orig$WaveAway$SBFolderBackgroundView$layoutSubviews(self, _cmd);
}
