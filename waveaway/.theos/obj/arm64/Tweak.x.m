...
@class SBIconImageView; @class SBIconRecentlyUpdatedLabelAccessoryView; @class _UIStatusBarStringView; @class SBIconLegibilityLabelView; @class SBIconCloudLabelAccessoryView; @class SBFolderTitleTextField; @class SBDockView; @class SBIconListPageControl; @class NCNotificationListSectionRevealHintView; @class SBIconBadgeView; @class _UIStatusBar; @class BSUICAPackageView; @class NCNotificationListView; @class SBIconBetaLabelAccessoryView; @class PSCapacityBarCell; 
...
static __attribute__((constructor)) void _logosLocalCtor_4fab20db(int __unused argc, char __unused **argv, char __unused **envp) {
